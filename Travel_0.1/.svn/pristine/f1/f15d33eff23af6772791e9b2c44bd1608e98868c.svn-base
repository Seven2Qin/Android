 ...
 * 类名称：     Lift3Menu
 * 作者：         Administrator
 * 创建时间：  2013年7月31日 下午3:15:56
 * 类描述：    
 * 版权声明 ： Copyright (C) 2008-2010 RichPeak
 * 修改时间：  2013年7月31日 下午3:15:56
 *
 */
public final class Left3Menu extends Dialog implements OnItemClickListener,
android.view.animation.Animation.AnimationListener
{
    ...
    public Left3Menu(Context context, int myMenuBit[], MenuItem Menu_Item)
    {
      ...
      //显示商铺字样
        ...
        txtView_Title.setText("商铺");

//        ImageView v = (ImageView)findViewById(R.id.ivpopup2);
//        v.setBackgroundResource(R.drawable.popup_title_up2);
//        v.setVisibility(View.VISIBLE);
        ...
        fl.setBackgroundResource(R.drawable.left3_up);
//        fl.setPadding(0, -5, 0, 0);
        ...
        menuGrid.setBackgroundResource(R.drawable.left3_down);
    ...
    public MapGridViewAdapter getMenuAdapter(int[] imageResourceArray)
    {
        ...
        MapGridViewAdapter simperAdapter = new MapGridViewAdapter(context,
                R.layout.report_menuitem, R.drawable.menubtn_left3_1, data);
    ...
    {
        isCloseAniEnd = false;
        com.mendong.travel.view.anim.AnimationUtils.openAnimateLeft3Menu(view, this);
    }

    public void closeAnimateReport()
    {
        com.mendong.travel.view.anim.AnimationUtils
                .closeAnimateLeft3(view, this);
        isCloseAniEnd = true;
    }
