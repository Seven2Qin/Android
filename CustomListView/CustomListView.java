package com.ztehealth.platform.views;
...
import com.ztehealth.platform.R;
...
//	private boolean mIsMoveToFirstItemAfterRefresh = false;
	 ...
	 * 14-12-09 新增字段
	 */
	public  static boolean mNoMoreDate= false;//判断是否加载完毕
	...
	private void init(Context pContext) {
		...
		try {
            ...
            drawable = getResources().getDrawable(R.drawable.listtview_scrll_img);
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(R.layout.custom_listview_head, null);
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(R.layout.custom_listview_footer_more, null);
	...
	private void  changeEndViewByState() {
		if (mCanLoadMore) {
			...
			case ENDINT_MANUAL_LOAD_DONE:// 手动刷新完成
				...
				if(mNoMoreDate)
				{
					mEndLoadTipsTextView.setText("已加载完成");
					mNoMoreDate=false;
				}
				else
...
//				}
	...
	public void VisualEndRootView() {
	    if(null != mEndRootView) {
	        TextView loadTV = (TextView) mEndRootView.findViewById(R.id.loading);
	        loadTV.setVisibility(View.VISIBLE);
	        TextView loadMoreTV = (TextView) mEndRootView.findViewById(R.id.load_more);
	        loadMoreTV.setVisibility(View.GONE);
	    }
	}
	
	public void HideEndRootView() {
	    if(null != mEndRootView) {
	        TextView loadTV = (TextView) mEndRootView.findViewById(R.id.loading);
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			mProgressBar.setVisibility(View.GONE);
			mArrowImageView.clearAnimation();
			mArrowImageView.setImageResource(R.drawable.weibo_arrow);
			// 下拉刷新
			mTipsTextView.setText(R.string.p2refresh_pull_to_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
